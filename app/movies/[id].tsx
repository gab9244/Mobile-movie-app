...
// Este componente serve para mostrar alguns dados similares da api, como titulo e texto, sem ter que repetir a criação dos mesmos componentes varias vezes
